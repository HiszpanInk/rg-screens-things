...
- Przydatne - wszelkie notatki i pomoce jakie zostały stworzone w trakcie kombinowania z wyświetlaczami
...
- Przydatne - any notes and helps which were created during tinkering with the displays
...
---
Podziękowania dla Mitsumiego✨ za Jego pracę i wkład w analizę wiadomości i dodanie skanów Jego notatek które są umieszczone w folderze przydatne, podziękowania dla Kornela za Jego pracę przy analizowaniu wiadomości i dostarczenie wyświetlaczy oraz sterownika
Thanks to Mitsumi✨ for His work in analysing the messages and providing scans of His notes that are included in Przydatne folder, thanks to Kornel for His work in analysing the messages and providing the screens and the controller
